...
plt.plot(dataPmt_DS[:,0], dataPmt_DS[:,1] , color = '#6a5acd') #wykres po downsamplingu danych bez filtrowania
plt.title('Wykres po downsamplingu danych bez filtrowania')
plt.show()
plt.plot(dataPmt_corr_DS[:,0], dataPmt_corr_DS[:,1] , color = '#6a5acd') #wykres po downsamplingu i po filtrowaniu
